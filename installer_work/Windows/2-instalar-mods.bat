...
REM --- Limpiar cache viejo del bootstrap en TEMP y LOCALAPPDATA ---
...
REM packwiz-installer guarda cache aqui
if exist "%LOCALAPPDATA%\packwiz-installer" rmdir /s /q "%LOCALAPPDATA%\packwiz-installer" 2>nul
if exist "%LOCALAPPDATA%\packwiz" rmdir /s /q "%LOCALAPPDATA%\packwiz" 2>nul
...
echo.
echo Sincronizando mods a !MODS_DEST! ...
REM --- Limpiar mods viejos para evitar huerfanos cuando se sacan del pack ---
del /Q "!MODS_DEST!\*.jar" 2>nul
...
if exist "!MODS_TEMP!\shaderpacks" (
    ...
    REM --- Limpiar shaderpacks viejos ---
    del /Q "!INSTANCE_DIR!\shaderpacks\*" 2>nul
